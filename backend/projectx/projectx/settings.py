...
DERIV_OAUTH_REDIRECT_URI = 'https://traderiserdigister.vercel.app/callback'   # MUST match what you registered in Deriv Dashboard
#DERIV_OAUTH_REDIRECT_URI = "http://localhost:3002/callback/" 
