...
from .models import ForexPair, Position, ForexTrade, ForexRobot, UserRobot, BotLog, TIME_FRAMES
...
class PositionSerializer(serializers.ModelSerializer):
    ...
    # Show account info (useful for Pro-FX vs MT5)
    ...
    class Meta:
        ...
        fields = '__all__'
        read_only_fields = (
            'user', 'account', 'entry_price', 'entry_time', 
            'floating_p_l', 'status', 'close_price', 'closed_at'
        )
...
class UserRobotSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = '__all__'
        read_only_fields = (
            'user', 'purchased_at', 'is_running', 
            'last_trade_time', 'is_ea'
        )
