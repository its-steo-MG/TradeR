...
from .views import ResendOTPView, SignupView, LoginView, SashiToggleView, AccountDetailView, ResetDemoBalanceView, CreateAdditionalAccountView, SwitchWalletView, VerifyEmailView, password_reset_request, password_reset_verify, password_reset_confirm,AppealSuspensionView,KYCSubmitView
