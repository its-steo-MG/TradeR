...
export default function WithdrawalModal({
  ...
  const requestWithdraw = async () => {
    ...
    try {
      const resp = await api.requestAgentWithdrawal(
        payload as Parameters<typeof api.requestAgentWithdrawal>[0]
      )
      if (resp.error) {
  ...
  const verifyOtp = async () => {
    ...
    setLoading(true)
    try {
      const resp = await api.verifyAgentWithdrawal({
        ...
        <div className="bg-gradient-to-r from-purple-600 to-purple-700 p-5 text-white">
          <div className="flex items-center justify-between">
            {step !== "amount" && (
              <button
                onClick={() =>
                  setStep(step === "otp" ? "details" : "amount")
                }
                className="p-1"
              >
            ...
            <>
              ...
              <div>
                ...
                <p className="text-center mt-3 text-lg">
                  ...
                  <span className="font-bold text-purple-600">{kes} KES</span>
                </p>
              </div>
              ...
              <button
                ...
                disabled={!isAmountOk()}
                className="
                  drop-on-top relative w-full py-4
                  bg-gradient-to-r from-purple-600 to-purple-700
                  disabled:from-slate-300 text-white font-bold text-lg
          ...
          {step === "otp" && (
            <div className="text-center space-y-6">
              ...
              <button
                ...
                "
              >
                <span className="relative z-[1]">Verify OTP</span>
              </button>
            </div>
          )}
