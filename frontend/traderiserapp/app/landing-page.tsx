...
export default function LandingPage() {
  ...
  const handleJoin = () => {
    window.open(
      "https://whatsapp.com/channel/0029VbBh1Yr4tRrntmwk9T3i",
      "_blank"
    )
  }
            ...
            <div className="space-y-4 sm:space-y-5 mb-6 bg-white/5 rounded-lg sm:rounded-xl p-4 sm:p-5 border border-white/10">
              ...
              <ol className="space-y-2 sm:space-y-3 text-xs sm:text-sm text-white/90">
                <li className="flex gap-2">
                  ...
                  <div>
                    ...
                    <span className="text-white/70 text-xs">
                      This unlocks access to Traderiser, MT5, and more.
                    </span>
                  </div>
                </li>
                <li className="flex gap-2">
                  ...
                  <div>
                    <strong>Connect to MT5</strong> using your Traderiser
                    account.
                    <br />
                    <span className="text-white/70 text-xs">
                ...
                <li className="flex gap-2">
                  ...
                  <div>
                    Choose between <strong>Traderiser</strong> or{" "}
                    <strong>MT5</strong> trading interface.
                  </div>
                </li>
              </ol>
              ...
              <div className="mt-4 sm:mt-5 space-y-2 sm:space-y-3 text-xs text-white/70 border-t border-white/10 pt-4">
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    Report fraud:{" "}
                    <a
                      href="mailto:traderiserpro@gmail.com"
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <h3 className="text-base sm:text-lg font-bold text-white">
                  Join TRADERISER WhatsApp
                </h3>
              </div>

              <p className="text-white/90 text-xs sm:text-sm leading-relaxed">
                Stay connected with exclusive trading signals, real-time market
                updates, expert tips, and community insights.
                <br />
              ...
              <div className="flex flex-col gap-2 sm:gap-3">
                <button
                  ...
                  className="
                    ...
                    py-2.5 sm:py-3 px-4 rounded-xl transition-colors text-sm sm:text-base
                  "
                >
                ...
                <button
                  ...
                  "
                >
                  <span className="relative z-[1]">I Have Already Joined</span>
                </button>
              </div>
        ...
        <div className="w-full max-w-2xl space-y-8 sm:space-y-10 md:space-y-12">
          ...
          <div className="rounded-2xl sm:rounded-3xl p-6 sm:p-8 bg-white/10 backdrop-blur-md border border-white/20 shadow-xl">
            <div className="flex flex-col gap-4 sm:gap-6">
              {/* TRADERISER — original orange, liquid drop on top */}
              <Link href="/login">
                <div className="drop-on-top group relative rounded-2xl sm:rounded-3xl p-5 sm:p-6 bg-gradient-to-br from-orange-100 to-orange-50 hover:shadow-xl transition-all duration-300 cursor-pointer overflow-hidden">
                  <div className="relative z-[1] flex items-center gap-4 sm:gap-6">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-gray-700 text-sm sm:text-base mt-1">
                        Trade on our powerful web terminal with Real & Demo
                        accounts.
                      </p>
                    </div>
              ...
              {/* MT5 — original blue, liquid drop on top */}
              <Link href="/mt5">
                <div className="drop-on-top group relative rounded-2xl sm:rounded-3xl p-5 sm:p-6 bg-gradient-to-br from-blue-100 to-blue-50 hover:shadow-xl transition-all duration-300 cursor-pointer overflow-hidden">
                  <div className="relative z-[1] flex items-center gap-4 sm:gap-6">
                    <div className="flex-shrink-0">
                      <div className="w-14 h-14 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-full flex items-center justify-center overflow-hidden shadow-md bg-white/60">
                        <Image
                          ...
                          width={96}
                          height={96}
                          className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:w-20 object-cover"
                        />
                      </div>
                    </div>
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-gray-700 text-sm sm:text-base mt-1">
                        Connect with your Traderiser account and trade on MT5
                        (Real & Demo).
                      </p>
                    </div>
                    <ChevronRight className="w-6 h-6 sm:w-7 sm:h-7 text-gray-900 flex-shrink-0 group-hover:translate-x-1 transition-transform" />
              ...
              {/* DERIV — original emerald, liquid drop on top */}
              <Link href="/login?type=deriv">
                <div className="drop-on-top group relative rounded-2xl sm:rounded-3xl p-5 sm:p-6 bg-gradient-to-br from-emerald-100 to-emerald-50 hover:shadow-xl transition-all duration-300 cursor-pointer overflow-hidden">
                  <div className="relative z-[1] flex items-center gap-4 sm:gap-6">
                    <div className="flex-shrink-0">
                      <div className="w-14 h-14 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-full flex items-center justify-center overflow-hidden shadow-md bg-white/60">
                        <Image
